...
func (mock *MockSender) Send(log log.Logger, applyResult webhooks.ApplyResult) error {
...
func (verifier *VerifierSender) Send(log log.Logger, applyResult webhooks.ApplyResult) *Sender_Send_OngoingVerification {
	params := []pegomock.Param{log, applyResult}
...
func (c *Sender_Send_OngoingVerification) GetCapturedArguments() (log.Logger, webhooks.ApplyResult) {
	log, applyResult := c.GetAllCapturedArguments()
	return log[len(log)-1], applyResult[len(applyResult)-1]
}

func (c *Sender_Send_OngoingVerification) GetAllCapturedArguments() (_param0 []log.Logger, _param1 []webhooks.ApplyResult) {
